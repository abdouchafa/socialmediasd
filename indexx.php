...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO posts(userId, content, created_at) VALUES ('$userId', '$content', '$created_at')";
...
if(isset($_POST['subcom'])){
  ...
  $postid = $_POST['postid'];
  $comsql = "INSERT INTO commants(postid, content) VALUES ('$postid','$comment')";
  $rescom= mysqli_query($con,$comsql) OR die ('error');
  
}
$getcom = "SELECT * FROM commants";
  

$posts = "SELECT * FROM posts ORDER BY id DESC";
$postres = mysqli_query($con,$posts) or die("error 2");
?>
  ...
  <body>
    ...
    <div class="main__body">
      ...
      <div class="feed">
        ...
        <?php 
          $postres = mysqli_query($con,$posts);
          while ($postarr =  mysqli_fetch_array($postres)){
          if($postarr['userId'] == $_SESSION['id'] ){
          ?>
        <div class="post">
          <div class="post__top">
          <img
            ...
            <div class="post__topInfo">
              <input type="text" name="postid" class="hidden" value="<?php echo $postarr['id'] ?>">
              <h3><?php echo $_SESSION['username'];  ?></h3>
              <p> <?php echo $postarr['created_at'];  ?></p>
            </div>
          </div>

          <div class="post__bottom">
            <p><?php echo $postarr['content'];?></p>
          </div>
          ...
          <div class="post__options">
            ...
            <div class="post__option" onclick="comment()">
          ...
          <div class="comment hidden">
            ...
            <button type="submit" name="subcom" class="btn btn--primary comment__send" >Send</button>
            </form>
          </div>
          <?php
          $comget = mysqli_query($con,$getcom);
          while ($com = mysqli_fetch_array($comget)){
           if($com['postid'] == $postarr['id']){ ?>
          <div class="post__bottom backgrey">
            <p>
              <?php
                echo  $com['content'];
            ?>
